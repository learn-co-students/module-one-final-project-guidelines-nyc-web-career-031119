class CLI
  ...
  def art_
    puts "                   ______       _           ___        ______   _
                  |  ___|      | |         / _ \\      | ___ \   | |
                  | | _ ___ ___| |_ ______/ /_\\ \\_____| |_/ /__| |_
                  |  _/ _ \/ __|__ |_______|  _  |_____|  __/  _\\ __|
                  | || (_) \__ \ |_|        | | | |     | | |  __/ |_
  ...
  def greet
    puts ""
    puts '         Welcome Friend, Thank you for helping our pets have a temporary home!'
    puts
    puts
    puts "                             Let's Begin!"
  end
      ...
      if u_input == "1"
        ...
        if sec_input == "A"
          if @user.animals.empty?
            ...
            puts "4. Four weeks"
            puts "5. Five weeks"
            fost_input = gets.chomp.capitalize
